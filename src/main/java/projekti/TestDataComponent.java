...
public class TestDataComponent implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        //add test messages
        WepaMessage message1 = new WepaMessage(user1,LocalDateTime.now(),"testiviesti #1", new ArrayList<>(), new ArrayList<>());
        this.wepaMessageRepository.save(message1);
        WepaMessage message2 = new WepaMessage(user1,LocalDateTime.now(),"testiviesti #2", new ArrayList<>(), new ArrayList<>());
        this.wepaMessageRepository.save(message2);
        WepaMessage message3 = new WepaMessage(user1,LocalDateTime.now(),"testiviesti #3", new ArrayList<>(), new ArrayList<>());
        this.wepaMessageRepository.save(message3);
        WepaMessage message4 = new WepaMessage(user1,LocalDateTime.now(),"testiviesti #4", new ArrayList<>(), new ArrayList<>());
